<?php
/**
 * Class helper_plugin_bureaucracyau_fieldsubmit
 *
 * Creates a submit button
 */
class helper_plugin_bureaucracyau_fieldsubmit extends helper_plugin_bureaucracyau_field {
    ...
    public function renderfield($params, Doku_Form $form, $formid) {
        if(!isset(helper_plugin_bureaucracyau_fieldsubmit::$captcha_displayed[$formid])) {
            helper_plugin_bureaucracyau_fieldsubmit::$captcha_displayed[$formid] = true;
    ...
    public function handle_post($value, &$fields, $index, $formid) {
        ...
        if(!isset(helper_plugin_bureaucracyau_fieldsubmit::$captcha_checked[$formid])) {
            helper_plugin_bureaucracyau_fieldsubmit::$captcha_checked[$formid] = true;
            // check CAPTCHA
            /** @var helper_plugin_captcha $helper */
            $helper = null;
            if(@is_dir(DOKU_PLUGIN.'captcha')) $helper = plugin_load('helper','captcha');
